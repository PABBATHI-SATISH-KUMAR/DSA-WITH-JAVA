...
// 17) Given an 2D array of M rows and N columns   write a program to print all the elements in the array using only one for loop
...
// 17) Given an 2D array of M rows and N columns   write a program to print all the elements in the array using only one for loop
public static void printOneFor(int[][] matrix){
